...
namespace Zenject {
  ...
  class MethodProviderWithContainer_2 : public ::Il2CppObject/*, public Zenject::IProvider*/ {
    ...
    System::Func_3<Zenject::DiContainer*, TParam1, TValue>*& dyn__method() {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::MethodProviderWithContainer_2::dyn__method");
