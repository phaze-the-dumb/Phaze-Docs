...
namespace System {
  ...
  class Func_12 : public System::MulticastDelegate {
    public:
    // Creating value type constructor for type: Func_12
    Func_12() noexcept {}
    ...
    static Func_12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, TResult>* New_ctor(::Il2CppObject* object, System::IntPtr method) {
      static auto ___internal__logger = ::Logger::get().WithContext("System::Func_12::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<Func_12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, TResult>*, creationType>(object, method)));
    }
