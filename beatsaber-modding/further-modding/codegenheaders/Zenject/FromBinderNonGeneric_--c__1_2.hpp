...
namespace Zenject {
  ...
  // Autogenerated type: Zenject.FromBinderNonGeneric/Zenject.<>c__1`2
  ...
  class FromBinderNonGeneric::$$c__1_2 : public ::Il2CppObject {
    ...
    // Get static field: static public readonly Zenject.FromBinderNonGeneric/Zenject.<>c__1`2<TConcrete,TFactory> <>9
    ...
    // Set static field: static public readonly Zenject.FromBinderNonGeneric/Zenject.<>c__1`2<TConcrete,TFactory> <>9
  ...
  }; // Zenject.FromBinderNonGeneric/Zenject.<>c__1`2
  // Could not write size check! Type: Zenject.FromBinderNonGeneric/Zenject.<>c__1`2 is generic, or has no fields that are valid for size checks!
}
