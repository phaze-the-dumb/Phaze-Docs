...
namespace LiteNetLib::Utils {
  ...
  // Autogenerated type: LiteNetLib.Utils.NetPacketProcessor/LiteNetLib.Utils.<>c__DisplayClass31_0`2
  ...
  class NetPacketProcessor::$$c__DisplayClass31_0_2 : public ::Il2CppObject {
    ...
    T& dyn_reference() {
      static auto ___internal__logger = ::Logger::get().WithContext("LiteNetLib::Utils::NetPacketProcessor::$$c__DisplayClass31_0_2::dyn_reference");
    ...
    System::Action_2<T, TUserData>*& dyn_onReceive() {
      static auto ___internal__logger = ::Logger::get().WithContext("LiteNetLib::Utils::NetPacketProcessor::$$c__DisplayClass31_0_2::dyn_onReceive");
      auto ___internal__instance = this;
  ...
  }; // LiteNetLib.Utils.NetPacketProcessor/LiteNetLib.Utils.<>c__DisplayClass31_0`2
  // Could not write size check! Type: LiteNetLib.Utils.NetPacketProcessor/LiteNetLib.Utils.<>c__DisplayClass31_0`2 is generic, or has no fields that are valid for size checks!
}
