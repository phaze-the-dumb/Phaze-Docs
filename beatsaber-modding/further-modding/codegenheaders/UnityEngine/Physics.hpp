...
namespace UnityEngine {
  ...
  // [StaticAccessorAttribute] Offset: DC89FC
  // [NativeHeaderAttribute] Offset: DC89FC
  class Physics : public ::Il2CppObject {
    ...
    // Offset: 0x2403360
    static ::Array<UnityEngine::RaycastHit>* Internal_RaycastAll_Injected(ByRef<UnityEngine::PhysicsScene> physicsScene, ByRef<UnityEngine::Ray> ray, float maxDistance, int mask, UnityEngine::QueryTriggerInteraction queryTriggerInteraction);
    ...
    // Offset: 0x2403FBC
    static ::Array<UnityEngine::RaycastHit>* Query_SphereCastAll_Injected(ByRef<UnityEngine::PhysicsScene> physicsScene, ByRef<UnityEngine::Vector3> origin, float radius, ByRef<UnityEngine::Vector3> direction, float maxDistance, int mask, UnityEngine::QueryTriggerInteraction queryTriggerInteraction);
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Array<UnityEngine::RaycastHit>* (*)(ByRef<UnityEngine::PhysicsScene>, ByRef<UnityEngine::Ray>, float, int, UnityEngine::QueryTriggerInteraction)>(&UnityEngine::Physics::Internal_RaycastAll_Injected)> {
  static const MethodInfo* get() {
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Array<UnityEngine::RaycastHit>* (*)(ByRef<UnityEngine::PhysicsScene>, ByRef<UnityEngine::Vector3>, float, ByRef<UnityEngine::Vector3>, float, int, UnityEngine::QueryTriggerInteraction)>(&UnityEngine::Physics::Query_SphereCastAll_Injected)> {
  static const MethodInfo* get() {
    static auto* physicsScene = &::il2cpp_utils::GetClassFromName("UnityEngine", "PhysicsScene")->this_arg;
