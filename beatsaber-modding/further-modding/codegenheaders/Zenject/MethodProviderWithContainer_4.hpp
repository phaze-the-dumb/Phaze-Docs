...
namespace Zenject {
  ...
  class MethodProviderWithContainer_4 : public ::Il2CppObject/*, public Zenject::IProvider*/ {
    ...
    // Get instance field: private readonly System.Func`5<Zenject.DiContainer,TParam1,TParam2,TParam3,TValue> _method
    System::Func_5<Zenject::DiContainer*, TParam1, TParam2, TParam3, TValue>*& dyn__method() {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::MethodProviderWithContainer_4::dyn__method");
      auto ___internal__instance = this;
      static auto ___internal__field__offset = THROW_UNLESS(il2cpp_utils::FindField(___internal__instance, "_method"))->offset;
      return *reinterpret_cast<System::Func_5<Zenject::DiContainer*, TParam1, TParam2, TParam3, TValue>**>(reinterpret_cast<char*>(this) + ___internal__field__offset);
    }
