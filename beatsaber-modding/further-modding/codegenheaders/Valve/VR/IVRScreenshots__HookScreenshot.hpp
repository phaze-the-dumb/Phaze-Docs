...
namespace Valve::VR {
  ...
  // [UnmanagedFunctionPointerAttribute] Offset: DF90F4
  class IVRScreenshots::_HookScreenshot : public System::MulticastDelegate {
    ...
    // Offset: 0x1D46E84
    Valve::VR::EVRScreenshotError Invoke(ByRef<::Array<Valve::VR::EVRScreenshotType>*> pSupportedTypes, int numTypes);
    ...
    // Offset: 0x1D470FC
    System::IAsyncResult* BeginInvoke(ByRef<::Array<Valve::VR::EVRScreenshotType>*> pSupportedTypes, int numTypes, System::AsyncCallback* callback, ::Il2CppObject* object);
...
// Il2CppName: Invoke
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<Valve::VR::EVRScreenshotError (Valve::VR::IVRScreenshots::_HookScreenshot::*)(ByRef<::Array<Valve::VR::EVRScreenshotType>*>, int)>(&Valve::VR::IVRScreenshots::_HookScreenshot::Invoke)> {
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<System::IAsyncResult* (Valve::VR::IVRScreenshots::_HookScreenshot::*)(ByRef<::Array<Valve::VR::EVRScreenshotType>*>, int, System::AsyncCallback*, ::Il2CppObject*)>(&Valve::VR::IVRScreenshots::_HookScreenshot::BeginInvoke)> {
  static const MethodInfo* get() {
    static auto* pSupportedTypes = &il2cpp_functions::array_class_get(::il2cpp_utils::GetClassFromName("Valve.VR", "EVRScreenshotType"), 1)->this_arg;
    static auto* numTypes = &::il2cpp_utils::GetClassFromName("System", "Int32")->byval_arg;
