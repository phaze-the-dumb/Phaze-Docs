...
namespace LiteNetLib::Utils {
  ...
  // Autogenerated type: LiteNetLib.Utils.NetSerializer/LiteNetLib.Utils.UIntSerializer`1
  // [TokenAttribute] Offset: FFFFFFFF
  template<typename T>
  class NetSerializer::UIntSerializer_1 : public LiteNetLib::Utils::NetSerializer::FastCallSpecific_2<T, uint> {
    public:
    // Creating value type constructor for type: UIntSerializer_1
    UIntSerializer_1() noexcept {}
    ...
    static NetSerializer::UIntSerializer_1<T>* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("LiteNetLib::Utils::NetSerializer::UIntSerializer_1::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<NetSerializer::UIntSerializer_1<T>*, creationType>()));
    }
    ...
    void Read(T inf, LiteNetLib::Utils::NetDataReader* r) {
      static auto ___internal__logger = ::Logger::get().WithContext("LiteNetLib::Utils::NetSerializer::UIntSerializer_1::Read");
    ...
    void Write(T inf, LiteNetLib::Utils::NetDataWriter* w) {
      static auto ___internal__logger = ::Logger::get().WithContext("LiteNetLib::Utils::NetSerializer::UIntSerializer_1::Write");
    ...
    void ReadArray(T inf, LiteNetLib::Utils::NetDataReader* r) {
      static auto ___internal__logger = ::Logger::get().WithContext("LiteNetLib::Utils::NetSerializer::UIntSerializer_1::ReadArray");
    ...
    void WriteArray(T inf, LiteNetLib::Utils::NetDataWriter* w) {
      static auto ___internal__logger = ::Logger::get().WithContext("LiteNetLib::Utils::NetSerializer::UIntSerializer_1::WriteArray");
  ...
  }; // LiteNetLib.Utils.NetSerializer/LiteNetLib.Utils.UIntSerializer`1
  // Could not write size check! Type: LiteNetLib.Utils.NetSerializer/LiteNetLib.Utils.UIntSerializer`1 is generic, or has no fields that are valid for size checks!
}
