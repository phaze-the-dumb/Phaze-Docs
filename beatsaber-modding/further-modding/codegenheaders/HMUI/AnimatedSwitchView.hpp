...
namespace HMUI {
  ...
  // [RequireComponent] Offset: E1AC94
  class AnimatedSwitchView : public UnityEngine::MonoBehaviour {
    ...
    // [SpaceAttribute] Offset: 0xE1C0C4
    ...
    // Field size check
    static_assert(sizeof(TMPro::TextMeshProUGUI*) == 0x8);
    // [SpaceAttribute] Offset: 0xE1C12C
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [SpaceAttribute] Offset: 0xE1C184
    ...
    char __padding9[0x4] = {};
    // [SpaceAttribute] Offset: 0xE1C1CC
