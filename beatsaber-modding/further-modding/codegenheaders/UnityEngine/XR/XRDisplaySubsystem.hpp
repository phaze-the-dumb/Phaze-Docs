...
namespace UnityEngine::XR {
  ...
  // [NativeTypeAttribute] Offset: DDBF40
  // [NativeHeaderAttribute] Offset: DDBF40
  // [NativeConditionalAttribute] Offset: DDBF40
  // [UsedByNativeCodeAttribute] Offset: DDBF40
  class XRDisplaySubsystem : public UnityEngine::IntegratedSubsystem_1<UnityEngine::XR::XRDisplaySubsystemDescriptor*> {
    ...
    // [DebuggerBrowsableAttribute] Offset: 0xDDC608
