...
namespace Org::BouncyCastle::Math::EC::Custom::Sec {
  ...
  class SecT163R2Curve : public Org::BouncyCastle::Math::EC::AbstractF2mCurve {
    ...
    Org::BouncyCastle::Math::EC::Custom::Sec::SecT163R2Point*& dyn_m_infinity();
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<Org::BouncyCastle::Math::EC::ECLookupTable* (Org::BouncyCastle::Math::EC::Custom::Sec::SecT163R2Curve::*)(::Array<Org::BouncyCastle::Math::EC::ECPoint*>*, int, int)>(&Org::BouncyCastle::Math::EC::Custom::Sec::SecT163R2Curve::CreateCacheSafeLookupTable)> {
  static const MethodInfo* get() {
