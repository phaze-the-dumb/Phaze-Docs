...
namespace Valve::VR {
  ...
  // [UnmanagedFunctionPointerAttribute] Offset: DF8424
...
// Il2CppName: Invoke
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (Valve::VR::IVRChaperoneSetup::_SetWorkingCollisionBoundsTagsInfo::*)(ByRef<::Array<uint8_t>*>, uint)>(&Valve::VR::IVRChaperoneSetup::_SetWorkingCollisionBoundsTagsInfo::Invoke)> {
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<System::IAsyncResult* (Valve::VR::IVRChaperoneSetup::_SetWorkingCollisionBoundsTagsInfo::*)(ByRef<::Array<uint8_t>*>, uint, System::AsyncCallback*, ::Il2CppObject*)>(&Valve::VR::IVRChaperoneSetup::_SetWorkingCollisionBoundsTagsInfo::BeginInvoke)> {
  static const MethodInfo* get() {
    static auto* pTagsBuffer = &il2cpp_functions::array_class_get(::il2cpp_utils::GetClassFromName("System", "Byte"), 1)->this_arg;
    static auto* unTagCount = &::il2cpp_utils::GetClassFromName("System", "UInt32")->byval_arg;
