...
namespace OVR::OpenVR {
  ...
  // [UnmanagedFunctionPointerAttribute] Offset: DF2B08
  class IVRSystem::_GetDeviceToAbsoluteTrackingPose : public System::MulticastDelegate {
    ...
    // Offset: 0x20F664C
    void Invoke(OVR::OpenVR::ETrackingUniverseOrigin eOrigin, float fPredictedSecondsToPhotonsFromNow, ByRef<::Array<OVR::OpenVR::TrackedDevicePose_t>*> pTrackedDevicePoseArray, uint unTrackedDevicePoseArrayCount);
    ...
    // Offset: 0x20F6920
    System::IAsyncResult* BeginInvoke(OVR::OpenVR::ETrackingUniverseOrigin eOrigin, float fPredictedSecondsToPhotonsFromNow, ByRef<::Array<OVR::OpenVR::TrackedDevicePose_t>*> pTrackedDevicePoseArray, uint unTrackedDevicePoseArrayCount, System::AsyncCallback* callback, ::Il2CppObject* object);
...
// Il2CppName: Invoke
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (OVR::OpenVR::IVRSystem::_GetDeviceToAbsoluteTrackingPose::*)(OVR::OpenVR::ETrackingUniverseOrigin, float, ByRef<::Array<OVR::OpenVR::TrackedDevicePose_t>*>, uint)>(&OVR::OpenVR::IVRSystem::_GetDeviceToAbsoluteTrackingPose::Invoke)> {
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<System::IAsyncResult* (OVR::OpenVR::IVRSystem::_GetDeviceToAbsoluteTrackingPose::*)(OVR::OpenVR::ETrackingUniverseOrigin, float, ByRef<::Array<OVR::OpenVR::TrackedDevicePose_t>*>, uint, System::AsyncCallback*, ::Il2CppObject*)>(&OVR::OpenVR::IVRSystem::_GetDeviceToAbsoluteTrackingPose::BeginInvoke)> {
  static const MethodInfo* get() {
    static auto* eOrigin = &::il2cpp_utils::GetClassFromName("OVR.OpenVR", "ETrackingUniverseOrigin")->byval_arg;
    static auto* fPredictedSecondsToPhotonsFromNow = &::il2cpp_utils::GetClassFromName("System", "Single")->byval_arg;
    static auto* pTrackedDevicePoseArray = &il2cpp_functions::array_class_get(::il2cpp_utils::GetClassFromName("OVR.OpenVR", "TrackedDevicePose_t"), 1)->this_arg;
