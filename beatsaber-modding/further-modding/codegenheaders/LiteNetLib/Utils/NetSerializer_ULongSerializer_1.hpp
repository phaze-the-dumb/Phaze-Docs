...
namespace LiteNetLib::Utils {
  ...
  // Autogenerated type: LiteNetLib.Utils.NetSerializer/LiteNetLib.Utils.ULongSerializer`1
  ...
  class NetSerializer::ULongSerializer_1 : public LiteNetLib::Utils::NetSerializer::FastCallSpecific_2<T, uint64_t> {
    ...
    static NetSerializer::ULongSerializer_1<T>* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("LiteNetLib::Utils::NetSerializer::ULongSerializer_1::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<NetSerializer::ULongSerializer_1<T>*, creationType>()));
    }
    ...
    void Read(T inf, LiteNetLib::Utils::NetDataReader* r) {
      static auto ___internal__logger = ::Logger::get().WithContext("LiteNetLib::Utils::NetSerializer::ULongSerializer_1::Read");
    ...
    void Write(T inf, LiteNetLib::Utils::NetDataWriter* w) {
      static auto ___internal__logger = ::Logger::get().WithContext("LiteNetLib::Utils::NetSerializer::ULongSerializer_1::Write");
    ...
    void ReadArray(T inf, LiteNetLib::Utils::NetDataReader* r) {
      static auto ___internal__logger = ::Logger::get().WithContext("LiteNetLib::Utils::NetSerializer::ULongSerializer_1::ReadArray");
    ...
    void WriteArray(T inf, LiteNetLib::Utils::NetDataWriter* w) {
      static auto ___internal__logger = ::Logger::get().WithContext("LiteNetLib::Utils::NetSerializer::ULongSerializer_1::WriteArray");
  ...
  }; // LiteNetLib.Utils.NetSerializer/LiteNetLib.Utils.ULongSerializer`1
  // Could not write size check! Type: LiteNetLib.Utils.NetSerializer/LiteNetLib.Utils.ULongSerializer`1 is generic, or has no fields that are valid for size checks!
}
DEFINE_IL2CPP_ARG_TYPE_GENERIC_CLASS(LiteNetLib::Utils::NetSerializer::ULongSerializer_1, "LiteNetLib.Utils", "NetSerializer/ULongSerializer`1");
#include "extern/beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
