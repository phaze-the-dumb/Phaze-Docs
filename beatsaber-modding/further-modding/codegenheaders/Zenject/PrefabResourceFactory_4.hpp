...
namespace Zenject {
  ...
  class PrefabResourceFactory_4 : public ::Il2CppObject/*, public Zenject::IFactory_5<::Il2CppString*, P1, P2, P3, T>*/ {
    public:
    // [InjectAttribute] Offset: 0xE0347C
    ...
    // Creating value type constructor for type: PrefabResourceFactory_4
    PrefabResourceFactory_4(Zenject::DiContainer* container_ = {}) noexcept : container{container_} {}
