...
namespace GlobalNamespace {
  ...
  // [DefaultMemberAttribute] Offset: E34338
  class TrailElementCollection : public ::Il2CppObject {
    ...
    // Offset: 0x1074268
    int LenToSegment(float t, ByRef<float> localF);
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int (GlobalNamespace::TrailElementCollection::*)(float, ByRef<float>)>(&GlobalNamespace::TrailElementCollection::LenToSegment)> {
  static const MethodInfo* get() {
