...
namespace Zenject {
  ...
  class MonoMemoryPool_2 : public Zenject::MemoryPool_2<TParam1, TValue> {
    ...
    // Creating value type constructor for type: MonoMemoryPool_2
    MonoMemoryPool_2(UnityEngine::Transform* originalParent_ = {}) noexcept : originalParent{originalParent_} {}
