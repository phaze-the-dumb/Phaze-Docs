...
namespace Zenject {
  ...
  class MemoryPoolInitialSizeMaxSizeBinder_1 : public Zenject::MemoryPoolMaxSizeBinder_1<TContract> {
    ...
    Zenject::MemoryPoolMaxSizeBinder_1<TContract>* WithInitialSize(int size) {
      ...
      return ::il2cpp_utils::RunMethodThrow<Zenject::MemoryPoolMaxSizeBinder_1<TContract>*, false>(___instance_arg, ___internal__method, size);
    }
    ...
    Zenject::FactoryArgumentsToChoiceBinder_1<TContract>* WithFixedSize(int size) {
      ...
      auto ___instance_arg = this;
      return ::il2cpp_utils::RunMethodThrow<Zenject::FactoryArgumentsToChoiceBinder_1<TContract>*, false>(___instance_arg, ___internal__method, size);
    }
