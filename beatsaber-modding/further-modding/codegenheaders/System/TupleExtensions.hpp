...
namespace System {
  ...
  // [ExtensionAttribute] Offset: D9F05C
  class TupleExtensions : public ::Il2CppObject {
    ...
    static void Deconstruct(System::Tuple_2<T1, T2>* value, ByRef<T1> item1, ByRef<T2> item2) {
      ...
      ::il2cpp_utils::RunMethodThrow<void, false>(static_cast<Il2CppClass*>(nullptr), ___generic__method, value, byref(item1), byref(item2));
    }
