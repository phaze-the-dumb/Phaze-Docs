...
namespace Valve::VR {
  // Size: 0x70
  #pragma pack(push, 1)
  // Autogenerated type: Valve.VR.IVROverlay/Valve.VR._SetOverlayRaw
  // [TokenAttribute] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: DF8CA8
  ...
  }; // Valve.VR.IVROverlay/Valve.VR._SetOverlayRaw
  #pragma pack(pop)
}
