...
namespace GlobalNamespace {
  ...
  class AnnotatedBeatmapLevelCollectionsViewController : public HMUI::ViewController {
    ...
    // [InjectAttribute] Offset: 0xE477D4
    ...
    // Get instance field reference: private AnnotatedBeatmapLevelCollectionsTableView _annotatedBeatmapLevelCollectionsTableView
    GlobalNamespace::AnnotatedBeatmapLevelCollectionsTableView*& dyn__annotatedBeatmapLevelCollectionsTableView();
