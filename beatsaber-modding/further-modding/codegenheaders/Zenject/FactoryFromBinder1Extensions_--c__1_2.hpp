...
namespace Zenject {
  ...
  // Autogenerated type: Zenject.FactoryFromBinder1Extensions/Zenject.<>c__1`2
  ...
  class FactoryFromBinder1Extensions::$$c__1_2 : public ::Il2CppObject {
    ...
    // Get static field: static public readonly Zenject.FactoryFromBinder1Extensions/Zenject.<>c__1`2<TParam1,TContract> <>9
    ...
    // Set static field: static public readonly Zenject.FactoryFromBinder1Extensions/Zenject.<>c__1`2<TParam1,TContract> <>9
    ...
    static void _cctor() {
      ...
      static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<FactoryFromBinder1Extensions::$$c__1_2<TParam1, TContract>*>::get(), ".cctor", std::vector<Il2CppClass*>{}, ::std::vector<const Il2CppType*>{})));
  ...
  }; // Zenject.FactoryFromBinder1Extensions/Zenject.<>c__1`2
  // Could not write size check! Type: Zenject.FactoryFromBinder1Extensions/Zenject.<>c__1`2 is generic, or has no fields that are valid for size checks!
}
