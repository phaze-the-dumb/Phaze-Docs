...
namespace UnityEngine::Events {
  ...
  class InvokableCall_2 : public UnityEngine::Events::BaseInvokableCall {
    public:
    // [DebuggerBrowsableAttribute] Offset: 0xDB95C0
    ...
    // Creating value type constructor for type: InvokableCall_2
    InvokableCall_2(UnityEngine::Events::UnityAction_2<T1, T2>* Delegate_ = {}) noexcept : Delegate{Delegate_} {}
    ...
    void Invoke(T1 args0, T2 args1) {
      ...
      auto ___instance_arg = this;
      ::il2cpp_utils::RunMethodThrow<void, false>(___instance_arg, ___internal__method, args0, args1);
    }
