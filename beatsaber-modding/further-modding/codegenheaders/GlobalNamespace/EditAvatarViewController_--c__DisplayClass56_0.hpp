...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::EditAvatarViewController::$$c__DisplayClass56_0::*)()>(&GlobalNamespace::EditAvatarViewController::$$c__DisplayClass56_0::$SetupColorButton$b__0)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(GlobalNamespace::EditAvatarViewController::$$c__DisplayClass56_0*), "<SetupColorButton>b__0", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
// Writing MetadataGetter for method: GlobalNamespace::EditAvatarViewController::$$c__DisplayClass56_0::$SetupColorButton$b__1
// Il2CppName: <SetupColorButton>b__1
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::EditAvatarViewController::$$c__DisplayClass56_0::*)(UnityEngine::Color)>(&GlobalNamespace::EditAvatarViewController::$$c__DisplayClass56_0::$SetupColorButton$b__1)> {
  static const MethodInfo* get() {
    static auto* c = &::il2cpp_utils::GetClassFromName("UnityEngine", "Color")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(GlobalNamespace::EditAvatarViewController::$$c__DisplayClass56_0*), "<SetupColorButton>b__1", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{c});
  }
};
// Writing MetadataGetter for method: GlobalNamespace::EditAvatarViewController::$$c__DisplayClass56_0::New_ctor
// Il2CppName: .ctor
