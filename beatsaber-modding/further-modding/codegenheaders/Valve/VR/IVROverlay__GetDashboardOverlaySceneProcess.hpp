...
namespace Valve::VR {
  // Size: 0x70
  #pragma pack(push, 1)
  // Autogenerated type: Valve.VR.IVROverlay/Valve.VR._GetDashboardOverlaySceneProcess
  // [TokenAttribute] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: DF8D5C
  class IVROverlay::_GetDashboardOverlaySceneProcess : public System::MulticastDelegate {
    ...
    // Offset: 0x205F628
    Valve::VR::EVROverlayError Invoke(uint64_t ulOverlayHandle, ByRef<uint> punProcessId);
    ...
    // Offset: 0x205F95C
    Valve::VR::EVROverlayError EndInvoke(ByRef<uint> punProcessId, System::IAsyncResult* result);
  }; // Valve.VR.IVROverlay/Valve.VR._GetDashboardOverlaySceneProcess
  #pragma pack(pop)
}
...
// Il2CppName: Invoke
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<Valve::VR::EVROverlayError (Valve::VR::IVROverlay::_GetDashboardOverlaySceneProcess::*)(uint64_t, ByRef<uint>)>(&Valve::VR::IVROverlay::_GetDashboardOverlaySceneProcess::Invoke)> {
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<System::IAsyncResult* (Valve::VR::IVROverlay::_GetDashboardOverlaySceneProcess::*)(uint64_t, ByRef<uint>, System::AsyncCallback*, ::Il2CppObject*)>(&Valve::VR::IVROverlay::_GetDashboardOverlaySceneProcess::BeginInvoke)> {
  static const MethodInfo* get() {
    static auto* ulOverlayHandle = &::il2cpp_utils::GetClassFromName("System", "UInt64")->byval_arg;
    static auto* punProcessId = &::il2cpp_utils::GetClassFromName("System", "UInt32")->this_arg;
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<Valve::VR::EVROverlayError (Valve::VR::IVROverlay::_GetDashboardOverlaySceneProcess::*)(ByRef<uint>, System::IAsyncResult*)>(&Valve::VR::IVROverlay::_GetDashboardOverlaySceneProcess::EndInvoke)> {
  static const MethodInfo* get() {
    static auto* punProcessId = &::il2cpp_utils::GetClassFromName("System", "UInt32")->this_arg;
