...
namespace OVR::OpenVR {
  ...
  // [UnmanagedFunctionPointerAttribute] Offset: DF41C4
  class IVRInput::_DecompressSkeletalBoneData : public System::MulticastDelegate {
    ...
    // Offset: 0x1F5B6C4
    OVR::OpenVR::EVRInputError Invoke(System::IntPtr pvCompressedBuffer, uint unCompressedBufferSize, ByRef<OVR::OpenVR::EVRSkeletalTransformSpace> peTransformSpace, ByRef<::Array<OVR::OpenVR::VRBoneTransform_t>*> pTransformArray, uint unTransformArrayCount);
    ...
    // Offset: 0x1F5B998
    System::IAsyncResult* BeginInvoke(System::IntPtr pvCompressedBuffer, uint unCompressedBufferSize, ByRef<OVR::OpenVR::EVRSkeletalTransformSpace> peTransformSpace, ByRef<::Array<OVR::OpenVR::VRBoneTransform_t>*> pTransformArray, uint unTransformArrayCount, System::AsyncCallback* callback, ::Il2CppObject* object);
...
// Il2CppName: Invoke
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<OVR::OpenVR::EVRInputError (OVR::OpenVR::IVRInput::_DecompressSkeletalBoneData::*)(System::IntPtr, uint, ByRef<OVR::OpenVR::EVRSkeletalTransformSpace>, ByRef<::Array<OVR::OpenVR::VRBoneTransform_t>*>, uint)>(&OVR::OpenVR::IVRInput::_DecompressSkeletalBoneData::Invoke)> {
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<System::IAsyncResult* (OVR::OpenVR::IVRInput::_DecompressSkeletalBoneData::*)(System::IntPtr, uint, ByRef<OVR::OpenVR::EVRSkeletalTransformSpace>, ByRef<::Array<OVR::OpenVR::VRBoneTransform_t>*>, uint, System::AsyncCallback*, ::Il2CppObject*)>(&OVR::OpenVR::IVRInput::_DecompressSkeletalBoneData::BeginInvoke)> {
  static const MethodInfo* get() {
    static auto* pvCompressedBuffer = &::il2cpp_utils::GetClassFromName("System", "IntPtr")->byval_arg;
    static auto* unCompressedBufferSize = &::il2cpp_utils::GetClassFromName("System", "UInt32")->byval_arg;
    static auto* peTransformSpace = &::il2cpp_utils::GetClassFromName("OVR.OpenVR", "EVRSkeletalTransformSpace")->this_arg;
