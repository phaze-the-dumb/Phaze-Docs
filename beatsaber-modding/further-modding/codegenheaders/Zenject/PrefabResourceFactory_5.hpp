...
namespace Zenject {
  ...
  class PrefabResourceFactory_5 : public ::Il2CppObject/*, public Zenject::IFactory_6<::Il2CppString*, P1, P2, P3, P4, T>*/ {
    public:
    // [InjectAttribute] Offset: 0xE0348C
    ...
    Zenject::DiContainer*& dyn__container() {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::PrefabResourceFactory_5::dyn__container");
    ...
    T Create(::Il2CppString* prefabResourceName, P1 param, P2 param2, P3 param3, P4 param4) {
      ...
      auto ___instance_arg = this;
      return ::il2cpp_utils::RunMethodThrow<T, false>(___instance_arg, ___internal__method, prefabResourceName, param, param2, param3, param4);
    }
