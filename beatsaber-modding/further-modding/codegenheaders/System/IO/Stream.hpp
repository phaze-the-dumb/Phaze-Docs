...
namespace System::IO {
  ...
  // [ComVisibleAttribute] Offset: DA1A90
...
// Il2CppName: Read
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int (System::IO::Stream::*)(ByRef<::Array<uint8_t>*>, int, int)>(&System::IO::Stream::Read)> {
  static const MethodInfo* get() {
