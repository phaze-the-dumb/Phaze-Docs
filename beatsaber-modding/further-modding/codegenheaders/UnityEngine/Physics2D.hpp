...
namespace UnityEngine {
  ...
  // [StaticAccessorAttribute] Offset: DD7EE0
  // [NativeHeaderAttribute] Offset: DD7EE0
  // [NativeHeaderAttribute] Offset: DD7EE0
  // [NativeHeaderAttribute] Offset: DD7EE0
  class Physics2D : public ::Il2CppObject {
    ...
    // Offset: 0x2413F88
    static ::Array<UnityEngine::RaycastHit2D>* GetRayIntersectionAll_Internal_Injected(ByRef<UnityEngine::PhysicsScene2D> physicsScene, ByRef<UnityEngine::Vector3> origin, ByRef<UnityEngine::Vector3> direction, float distance, int layerMask);
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Array<UnityEngine::RaycastHit2D>* (*)(ByRef<UnityEngine::PhysicsScene2D>, ByRef<UnityEngine::Vector3>, ByRef<UnityEngine::Vector3>, float, int)>(&UnityEngine::Physics2D::GetRayIntersectionAll_Internal_Injected)> {
  static const MethodInfo* get() {
