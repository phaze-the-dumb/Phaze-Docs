...
namespace LiteNetLib::Utils {
  ...
  // Autogenerated type: LiteNetLib.Utils.NetPacketProcessor/LiteNetLib.Utils.<>c__DisplayClass25_0`1
  ...
  class NetPacketProcessor::$$c__DisplayClass25_0_1 : public ::Il2CppObject {
    ...
    System::Func_1<T>*& dyn_packetConstructor() {
      static auto ___internal__logger = ::Logger::get().WithContext("LiteNetLib::Utils::NetPacketProcessor::$$c__DisplayClass25_0_1::dyn_packetConstructor");
    ...
    LiteNetLib::Utils::NetPacketProcessor*& dyn_$$4__this() {
      static auto ___internal__logger = ::Logger::get().WithContext("LiteNetLib::Utils::NetPacketProcessor::$$c__DisplayClass25_0_1::dyn_$$4__this");
      auto ___internal__instance = this;
    ...
    System::Action_1<T>*& dyn_onReceive() {
      static auto ___internal__logger = ::Logger::get().WithContext("LiteNetLib::Utils::NetPacketProcessor::$$c__DisplayClass25_0_1::dyn_onReceive");
      auto ___internal__instance = this;
  ...
  }; // LiteNetLib.Utils.NetPacketProcessor/LiteNetLib.Utils.<>c__DisplayClass25_0`1
  // Could not write size check! Type: LiteNetLib.Utils.NetPacketProcessor/LiteNetLib.Utils.<>c__DisplayClass25_0`1 is generic, or has no fields that are valid for size checks!
}
