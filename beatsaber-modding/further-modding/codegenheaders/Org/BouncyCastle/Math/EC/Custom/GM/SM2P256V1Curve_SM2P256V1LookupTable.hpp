...
namespace Org::BouncyCastle::Math::EC::Custom::GM {
  // Size: 0x24
  #pragma pack(push, 1)
  // Autogenerated type: Org.BouncyCastle.Math.EC.Custom.GM.SM2P256V1Curve/Org.BouncyCastle.Math.EC.Custom.GM.SM2P256V1LookupTable
  ...
  class SM2P256V1Curve::SM2P256V1LookupTable : public Org::BouncyCastle::Math::EC::AbstractECLookupTable {
    ...
    // Get instance field reference: private readonly Org.BouncyCastle.Math.EC.Custom.GM.SM2P256V1Curve m_outer
    Org::BouncyCastle::Math::EC::Custom::GM::SM2P256V1Curve*& dyn_m_outer();
  ...
  }; // Org.BouncyCastle.Math.EC.Custom.GM.SM2P256V1Curve/Org.BouncyCastle.Math.EC.Custom.GM.SM2P256V1LookupTable
  #pragma pack(pop)
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<Org::BouncyCastle::Math::EC::ECPoint* (Org::BouncyCastle::Math::EC::Custom::GM::SM2P256V1Curve::SM2P256V1LookupTable::*)(int)>(&Org::BouncyCastle::Math::EC::Custom::GM::SM2P256V1Curve::SM2P256V1LookupTable::Lookup)> {
  static const MethodInfo* get() {
    ...
    return ::il2cpp_utils::FindMethod(classof(Org::BouncyCastle::Math::EC::Custom::GM::SM2P256V1Curve::SM2P256V1LookupTable*), "Lookup", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{index});
  }
};
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<Org::BouncyCastle::Math::EC::ECPoint* (Org::BouncyCastle::Math::EC::Custom::GM::SM2P256V1Curve::SM2P256V1LookupTable::*)(int)>(&Org::BouncyCastle::Math::EC::Custom::GM::SM2P256V1Curve::SM2P256V1LookupTable::LookupVar)> {
  static const MethodInfo* get() {
    static auto* index = &::il2cpp_utils::GetClassFromName("System", "Int32")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(Org::BouncyCastle::Math::EC::Custom::GM::SM2P256V1Curve::SM2P256V1LookupTable*), "LookupVar", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{index});
  }
};
