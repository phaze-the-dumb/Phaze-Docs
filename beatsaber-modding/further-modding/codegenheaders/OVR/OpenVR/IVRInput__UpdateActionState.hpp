...
namespace OVR::OpenVR {
  ...
  // [UnmanagedFunctionPointerAttribute] Offset: DF4138
  class IVRInput::_UpdateActionState : public System::MulticastDelegate {
    ...
    // Offset: 0x1F5FCB4
    OVR::OpenVR::EVRInputError Invoke(ByRef<::Array<OVR::OpenVR::VRActiveActionSet_t>*> pSets, uint unSizeOfVRSelectedActionSet_t, uint unSetCount);
    ...
    // Offset: 0x1F5FF48
    System::IAsyncResult* BeginInvoke(ByRef<::Array<OVR::OpenVR::VRActiveActionSet_t>*> pSets, uint unSizeOfVRSelectedActionSet_t, uint unSetCount, System::AsyncCallback* callback, ::Il2CppObject* object);
...
// Il2CppName: Invoke
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<OVR::OpenVR::EVRInputError (OVR::OpenVR::IVRInput::_UpdateActionState::*)(ByRef<::Array<OVR::OpenVR::VRActiveActionSet_t>*>, uint, uint)>(&OVR::OpenVR::IVRInput::_UpdateActionState::Invoke)> {
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<System::IAsyncResult* (OVR::OpenVR::IVRInput::_UpdateActionState::*)(ByRef<::Array<OVR::OpenVR::VRActiveActionSet_t>*>, uint, uint, System::AsyncCallback*, ::Il2CppObject*)>(&OVR::OpenVR::IVRInput::_UpdateActionState::BeginInvoke)> {
  static const MethodInfo* get() {
    static auto* pSets = &il2cpp_functions::array_class_get(::il2cpp_utils::GetClassFromName("OVR.OpenVR", "VRActiveActionSet_t"), 1)->this_arg;
    static auto* unSizeOfVRSelectedActionSet_t = &::il2cpp_utils::GetClassFromName("System", "UInt32")->byval_arg;
    static auto* unSetCount = &::il2cpp_utils::GetClassFromName("System", "UInt32")->byval_arg;
