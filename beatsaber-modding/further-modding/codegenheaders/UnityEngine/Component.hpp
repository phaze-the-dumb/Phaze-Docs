...
namespace UnityEngine {
  ...
  // [RequiredByNativeCodeAttribute] Offset: DB5424
  // [NativeHeaderAttribute] Offset: DB5424
  // [NativeClassAttribute] Offset: DB5424
  class Component : public UnityEngine::Object {
    ...
    ::Array<T>* GetComponentsInChildren(bool includeInactive) {
      ...
      static auto* ___generic__method = THROW_UNLESS(::il2cpp_utils::MakeGenericMethod(___internal__method, std::vector<Il2CppClass*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<T>::get()}));
      auto ___instance_arg = this;
      return ::il2cpp_utils::RunMethodThrow<::Array<T>*, false>(___instance_arg, ___generic__method, includeInactive);
    }
