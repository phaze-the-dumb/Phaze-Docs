...
namespace Org::BouncyCastle::Math::EC::Custom::Sec {
  ...
  class SecP160R1Curve : public Org::BouncyCastle::Math::EC::AbstractFpCurve {
    ...
    // Get instance field reference: protected readonly Org.BouncyCastle.Math.EC.Custom.Sec.SecP160R1Point m_infinity
    Org::BouncyCastle::Math::EC::Custom::Sec::SecP160R1Point*& dyn_m_infinity();
