...
namespace System {
  ...
  // [ComVisibleAttribute] Offset: D9F7C4
  class Enum/*, public System::ValueType, public System::IComparable, public System::IConvertible, public System::IFormattable*/ {
    ...
    // Offset: 0x1802DDC
    static bool GetEnumValuesAndNames(System::RuntimeType* enumType, ByRef<::Array<uint64_t>*> values, ByRef<::Array<::Il2CppString*>*> names);
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (*)(System::RuntimeType*, ByRef<::Array<uint64_t>*>, ByRef<::Array<::Il2CppString*>*>)>(&System::Enum::GetEnumValuesAndNames)> {
  static const MethodInfo* get() {
    static auto* enumType = &::il2cpp_utils::GetClassFromName("System", "RuntimeType")->byval_arg;
