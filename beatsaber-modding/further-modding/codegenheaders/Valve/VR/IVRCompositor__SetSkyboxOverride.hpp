...
namespace Valve::VR {
  ...
  // [UnmanagedFunctionPointerAttribute] Offset: DF85DC
  class IVRCompositor::_SetSkyboxOverride : public System::MulticastDelegate {
    ...
    // Offset: 0x205A5FC
    Valve::VR::EVRCompositorError Invoke(ByRef<::Array<Valve::VR::Texture_t>*> pTextures, uint unTextureCount);
    ...
    // Offset: 0x205A874
    System::IAsyncResult* BeginInvoke(ByRef<::Array<Valve::VR::Texture_t>*> pTextures, uint unTextureCount, System::AsyncCallback* callback, ::Il2CppObject* object);
...
// Il2CppName: Invoke
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<Valve::VR::EVRCompositorError (Valve::VR::IVRCompositor::_SetSkyboxOverride::*)(ByRef<::Array<Valve::VR::Texture_t>*>, uint)>(&Valve::VR::IVRCompositor::_SetSkyboxOverride::Invoke)> {
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<System::IAsyncResult* (Valve::VR::IVRCompositor::_SetSkyboxOverride::*)(ByRef<::Array<Valve::VR::Texture_t>*>, uint, System::AsyncCallback*, ::Il2CppObject*)>(&Valve::VR::IVRCompositor::_SetSkyboxOverride::BeginInvoke)> {
  static const MethodInfo* get() {
    static auto* pTextures = &il2cpp_functions::array_class_get(::il2cpp_utils::GetClassFromName("Valve.VR", "Texture_t"), 1)->this_arg;
    static auto* unTextureCount = &::il2cpp_utils::GetClassFromName("System", "UInt32")->byval_arg;
