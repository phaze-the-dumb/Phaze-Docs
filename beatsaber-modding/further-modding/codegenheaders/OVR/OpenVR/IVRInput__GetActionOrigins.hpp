...
namespace OVR::OpenVR {
  ...
  // [UnmanagedFunctionPointerAttribute] Offset: DF41EC
  class IVRInput::_GetActionOrigins : public System::MulticastDelegate {
    ...
    // Offset: 0x1F5BFA0
    OVR::OpenVR::EVRInputError Invoke(uint64_t actionSetHandle, uint64_t digitalActionHandle, ByRef<::Array<uint64_t>*> originsOut, uint originOutCount);
    ...
    // Offset: 0x1F5C258
    System::IAsyncResult* BeginInvoke(uint64_t actionSetHandle, uint64_t digitalActionHandle, ByRef<::Array<uint64_t>*> originsOut, uint originOutCount, System::AsyncCallback* callback, ::Il2CppObject* object);
...
// Il2CppName: Invoke
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<OVR::OpenVR::EVRInputError (OVR::OpenVR::IVRInput::_GetActionOrigins::*)(uint64_t, uint64_t, ByRef<::Array<uint64_t>*>, uint)>(&OVR::OpenVR::IVRInput::_GetActionOrigins::Invoke)> {
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<System::IAsyncResult* (OVR::OpenVR::IVRInput::_GetActionOrigins::*)(uint64_t, uint64_t, ByRef<::Array<uint64_t>*>, uint, System::AsyncCallback*, ::Il2CppObject*)>(&OVR::OpenVR::IVRInput::_GetActionOrigins::BeginInvoke)> {
  static const MethodInfo* get() {
    static auto* actionSetHandle = &::il2cpp_utils::GetClassFromName("System", "UInt64")->byval_arg;
    static auto* digitalActionHandle = &::il2cpp_utils::GetClassFromName("System", "UInt64")->byval_arg;
    static auto* originsOut = &il2cpp_functions::array_class_get(::il2cpp_utils::GetClassFromName("System", "UInt64"), 1)->this_arg;
