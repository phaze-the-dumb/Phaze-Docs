...
namespace Zenject {
  ...
  class IFactoryProvider_7 : public Zenject::IFactoryProviderBase_1<TContract> {
    public:
    // Creating value type constructor for type: IFactoryProvider_7
    IFactoryProvider_7() noexcept {}
    ...
    static IFactoryProvider_7<TParam1, TParam2, TParam3, TParam4, TParam5, TParam6, TContract>* New_ctor(Zenject::DiContainer* container, System::Guid factoryId) {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::IFactoryProvider_7::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<IFactoryProvider_7<TParam1, TParam2, TParam3, TParam4, TParam5, TParam6, TContract>*, creationType>(container, factoryId)));
    }
    ...
    void GetAllInstancesWithInjectSplit(Zenject::InjectContext* context, System::Collections::Generic::List_1<Zenject::TypeValuePair>* args, ByRef<System::Action*> injectAction, System::Collections::Generic::List_1<::Il2CppObject*>* buffer) {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::IFactoryProvider_7::GetAllInstancesWithInjectSplit");
  ...
  // Could not write size check! Type: Zenject.IFactoryProvider`7 is generic, or has no fields that are valid for size checks!
}
