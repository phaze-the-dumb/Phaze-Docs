...
namespace Zenject {
  ...
  class MonoMemoryPool_6 : public Zenject::MemoryPool_6<TParam1, TParam2, TParam3, TParam4, TParam5, TValue> {
    ...
    // Creating value type constructor for type: MonoMemoryPool_6
    MonoMemoryPool_6(UnityEngine::Transform* originalParent_ = {}) noexcept : originalParent{originalParent_} {}
