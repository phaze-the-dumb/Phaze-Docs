...
namespace Valve::VR {
  // Size: 0x70
  #pragma pack(push, 1)
  // Autogenerated type: Valve.VR.IVRNotifications/Valve.VR._RemoveNotification
  // [TokenAttribute] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: DF8FDC
  ...
  }; // Valve.VR.IVRNotifications/Valve.VR._RemoveNotification
  #pragma pack(pop)
}
