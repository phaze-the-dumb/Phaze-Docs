...
namespace Zenject {
  ...
  class IFactoryProvider_5 : public Zenject::IFactoryProviderBase_1<TContract> {
    public:
    // Creating value type constructor for type: IFactoryProvider_5
    IFactoryProvider_5() noexcept {}
  ...
  // Could not write size check! Type: Zenject.IFactoryProvider`5 is generic, or has no fields that are valid for size checks!
}
