...
namespace Zenject {
  ...
  class IFactory_10/*, public Zenject::IFactory*/ {
    public:
    // Creating value type constructor for type: IFactory_10
    IFactory_10() noexcept {}
    ...
    TValue Create(TParam1 param1, TParam2 param2, TParam3 param3, TParam4 param4, TParam5 param5, TParam6 param6, TParam7 param7, TParam8 param8, TParam9 param9) {
      ...
      return ::il2cpp_utils::RunMethodThrow<TValue, false>(___instance_arg, ___internal__method, param1, param2, param3, param4, param5, param6, param7, param8, param9);
    }
  }; // Zenject.IFactory`10
