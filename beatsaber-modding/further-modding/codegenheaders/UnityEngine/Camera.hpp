...
namespace UnityEngine {
  ...
  // [NativeHeaderAttribute] Offset: DB33BC
  // [NativeHeaderAttribute] Offset: DB33BC
  // [NativeHeaderAttribute] Offset: DB33BC
  // [RequireComponent] Offset: DB33BC
  // [NativeHeaderAttribute] Offset: DB33BC
  // [NativeHeaderAttribute] Offset: DB33BC
  // [UsedByNativeCodeAttribute] Offset: DB33BC
  // [NativeHeaderAttribute] Offset: DB33BC
  // [NativeHeaderAttribute] Offset: DB33BC
  class Camera : public UnityEngine::Behaviour {
    ...
    // Offset: 0x1C4BF98
    static int GetAllCamerasImpl(ByRef<::Array<UnityEngine::Camera*>*> cam);
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int (*)(ByRef<::Array<UnityEngine::Camera*>*>)>(&UnityEngine::Camera::GetAllCamerasImpl)> {
  static const MethodInfo* get() {
