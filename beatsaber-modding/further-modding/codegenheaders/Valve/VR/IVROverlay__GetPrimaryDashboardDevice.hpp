...
namespace Valve::VR {
  // Size: 0x70
  #pragma pack(push, 1)
  // Autogenerated type: Valve.VR.IVROverlay/Valve.VR._GetPrimaryDashboardDevice
  // [TokenAttribute] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: DF8D84
  ...
  }; // Valve.VR.IVROverlay/Valve.VR._GetPrimaryDashboardDevice
  #pragma pack(pop)
}
