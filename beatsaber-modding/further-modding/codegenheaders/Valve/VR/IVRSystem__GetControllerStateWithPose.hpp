...
namespace Valve::VR {
  ...
  // [UnmanagedFunctionPointerAttribute] Offset: DF7DE4
  class IVRSystem::_GetControllerStateWithPose : public System::MulticastDelegate {
    ...
    // Offset: 0x1D4DFA0
    bool Invoke(Valve::VR::ETrackingUniverseOrigin eOrigin, uint unControllerDeviceIndex, ByRef<Valve::VR::VRControllerState_t> pControllerState, uint unControllerStateSize, ByRef<Valve::VR::TrackedDevicePose_t> pTrackedDevicePose);
    ...
    // Offset: 0x1D4E29C
    System::IAsyncResult* BeginInvoke(Valve::VR::ETrackingUniverseOrigin eOrigin, uint unControllerDeviceIndex, ByRef<Valve::VR::VRControllerState_t> pControllerState, uint unControllerStateSize, ByRef<Valve::VR::TrackedDevicePose_t> pTrackedDevicePose, System::AsyncCallback* callback, ::Il2CppObject* object);
    ...
    // Offset: 0x1D4E3A4
    bool EndInvoke(ByRef<Valve::VR::VRControllerState_t> pControllerState, ByRef<Valve::VR::TrackedDevicePose_t> pTrackedDevicePose, System::IAsyncResult* result);
...
// Il2CppName: Invoke
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (Valve::VR::IVRSystem::_GetControllerStateWithPose::*)(Valve::VR::ETrackingUniverseOrigin, uint, ByRef<Valve::VR::VRControllerState_t>, uint, ByRef<Valve::VR::TrackedDevicePose_t>)>(&Valve::VR::IVRSystem::_GetControllerStateWithPose::Invoke)> {
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<System::IAsyncResult* (Valve::VR::IVRSystem::_GetControllerStateWithPose::*)(Valve::VR::ETrackingUniverseOrigin, uint, ByRef<Valve::VR::VRControllerState_t>, uint, ByRef<Valve::VR::TrackedDevicePose_t>, System::AsyncCallback*, ::Il2CppObject*)>(&Valve::VR::IVRSystem::_GetControllerStateWithPose::BeginInvoke)> {
  static const MethodInfo* get() {
    static auto* eOrigin = &::il2cpp_utils::GetClassFromName("Valve.VR", "ETrackingUniverseOrigin")->byval_arg;
    static auto* unControllerDeviceIndex = &::il2cpp_utils::GetClassFromName("System", "UInt32")->byval_arg;
    static auto* pControllerState = &::il2cpp_utils::GetClassFromName("Valve.VR", "VRControllerState_t")->this_arg;
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (Valve::VR::IVRSystem::_GetControllerStateWithPose::*)(ByRef<Valve::VR::VRControllerState_t>, ByRef<Valve::VR::TrackedDevicePose_t>, System::IAsyncResult*)>(&Valve::VR::IVRSystem::_GetControllerStateWithPose::EndInvoke)> {
  static const MethodInfo* get() {
    static auto* pControllerState = &::il2cpp_utils::GetClassFromName("Valve.VR", "VRControllerState_t")->this_arg;
    static auto* pTrackedDevicePose = &::il2cpp_utils::GetClassFromName("Valve.VR", "TrackedDevicePose_t")->this_arg;
