...
namespace Valve::VR {
  // Size: 0x70
  #pragma pack(push, 1)
  // Autogenerated type: Valve.VR.IVRSystem/Valve.VR._TriggerHapticPulse
  // [TokenAttribute] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: DF7DF8
  ...
  }; // Valve.VR.IVRSystem/Valve.VR._TriggerHapticPulse
  #pragma pack(pop)
}
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (Valve::VR::IVRSystem::_TriggerHapticPulse::*)(uint, uint, ::Il2CppChar)>(&Valve::VR::IVRSystem::_TriggerHapticPulse::Invoke)> {
  static const MethodInfo* get() {
    ...
    return ::il2cpp_utils::FindMethod(classof(Valve::VR::IVRSystem::_TriggerHapticPulse*), "Invoke", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{unControllerDeviceIndex, unAxisId, usDurationMicroSec});
  }
};
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<System::IAsyncResult* (Valve::VR::IVRSystem::_TriggerHapticPulse::*)(uint, uint, ::Il2CppChar, System::AsyncCallback*, ::Il2CppObject*)>(&Valve::VR::IVRSystem::_TriggerHapticPulse::BeginInvoke)> {
  static const MethodInfo* get() {
    ...
    return ::il2cpp_utils::FindMethod(classof(Valve::VR::IVRSystem::_TriggerHapticPulse*), "BeginInvoke", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{unControllerDeviceIndex, unAxisId, usDurationMicroSec, callback, object});
  }
};
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (Valve::VR::IVRSystem::_TriggerHapticPulse::*)(System::IAsyncResult*)>(&Valve::VR::IVRSystem::_TriggerHapticPulse::EndInvoke)> {
  static const MethodInfo* get() {
    ...
    return ::il2cpp_utils::FindMethod(classof(Valve::VR::IVRSystem::_TriggerHapticPulse*), "EndInvoke", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{result});
  }
};
