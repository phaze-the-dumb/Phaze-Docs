...
namespace Org::BouncyCastle::Math::EC::Custom::Sec {
  ...
  class SecT283K1Curve : public Org::BouncyCastle::Math::EC::AbstractF2mCurve {
    ...
    // Creating value type constructor for type: SecT283K1Curve
    SecT283K1Curve(Org::BouncyCastle::Math::EC::Custom::Sec::SecT283K1Point* m_infinity_ = {}) noexcept : m_infinity{m_infinity_} {}
    ...
    static ::Array<Org::BouncyCastle::Math::EC::ECFieldElement*>* _get_SECT283K1_AFFINE_ZS();
    // Set static field: static private readonly Org.BouncyCastle.Math.EC.ECFieldElement[] SECT283K1_AFFINE_ZS
    static void _set_SECT283K1_AFFINE_ZS(::Array<Org::BouncyCastle::Math::EC::ECFieldElement*>* value);
    // Get instance field reference: protected readonly Org.BouncyCastle.Math.EC.Custom.Sec.SecT283K1Point m_infinity
    Org::BouncyCastle::Math::EC::Custom::Sec::SecT283K1Point*& dyn_m_infinity();
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<Org::BouncyCastle::Math::EC::ECLookupTable* (Org::BouncyCastle::Math::EC::Custom::Sec::SecT283K1Curve::*)(::Array<Org::BouncyCastle::Math::EC::ECPoint*>*, int, int)>(&Org::BouncyCastle::Math::EC::Custom::Sec::SecT283K1Curve::CreateCacheSafeLookupTable)> {
  static const MethodInfo* get() {
