...
namespace GlobalNamespace {
  ...
  class LightsAnimator::$DisableDirectionalLightsCoroutine$d__11 : public ::Il2CppObject/*, public System::Collections::Generic::IEnumerator_1<::Il2CppObject*>*/ {
    ...
    // Creating value type constructor for type: $DisableDirectionalLightsCoroutine$d__11
    $DisableDirectionalLightsCoroutine$d__11(int $$1__state_ = {}, ::Il2CppObject* $$2__current_ = {}, float delay_ = {}, GlobalNamespace::LightsAnimator* $$4__this_ = {}) noexcept : $$1__state{$$1__state_}, $$2__current{$$2__current_}, delay{delay_}, $$4__this{$$4__this_} {}
