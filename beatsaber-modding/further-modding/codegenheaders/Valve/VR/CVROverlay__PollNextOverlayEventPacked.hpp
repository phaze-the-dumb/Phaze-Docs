...
namespace Valve::VR {
  // Size: 0x70
  #pragma pack(push, 1)
  // Autogenerated type: Valve.VR.CVROverlay/Valve.VR._PollNextOverlayEventPacked
  // [TokenAttribute] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: DF91F8
  class CVROverlay::_PollNextOverlayEventPacked : public System::MulticastDelegate {
    ...
    // Offset: 0x1712CCC
    bool Invoke(uint64_t ulOverlayHandle, ByRef<Valve::VR::VREvent_t_Packed> pEvent, uint uncbVREvent);
    ...
    // Offset: 0x17133B4
    System::IAsyncResult* BeginInvoke(uint64_t ulOverlayHandle, ByRef<Valve::VR::VREvent_t_Packed> pEvent, uint uncbVREvent, System::AsyncCallback* callback, ::Il2CppObject* object);
...
// Il2CppName: Invoke
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (Valve::VR::CVROverlay::_PollNextOverlayEventPacked::*)(uint64_t, ByRef<Valve::VR::VREvent_t_Packed>, uint)>(&Valve::VR::CVROverlay::_PollNextOverlayEventPacked::Invoke)> {
  static const MethodInfo* get() {
    ...
    return ::il2cpp_utils::FindMethod(classof(Valve::VR::CVROverlay::_PollNextOverlayEventPacked*), "Invoke", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{ulOverlayHandle, pEvent, uncbVREvent});
  }
};
// Writing MetadataGetter for method: Valve::VR::CVROverlay::_PollNextOverlayEventPacked::BeginInvoke
// Il2CppName: BeginInvoke
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<System::IAsyncResult* (Valve::VR::CVROverlay::_PollNextOverlayEventPacked::*)(uint64_t, ByRef<Valve::VR::VREvent_t_Packed>, uint, System::AsyncCallback*, ::Il2CppObject*)>(&Valve::VR::CVROverlay::_PollNextOverlayEventPacked::BeginInvoke)> {
  static const MethodInfo* get() {
    static auto* ulOverlayHandle = &::il2cpp_utils::GetClassFromName("System", "UInt64")->byval_arg;
    static auto* pEvent = &::il2cpp_utils::GetClassFromName("Valve.VR", "VREvent_t_Packed")->this_arg;
    static auto* uncbVREvent = &::il2cpp_utils::GetClassFromName("System", "UInt32")->byval_arg;
    ...
    return ::il2cpp_utils::FindMethod(classof(Valve::VR::CVROverlay::_PollNextOverlayEventPacked*), "BeginInvoke", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{ulOverlayHandle, pEvent, uncbVREvent, callback, object});
  }
};
// Writing MetadataGetter for method: Valve::VR::CVROverlay::_PollNextOverlayEventPacked::EndInvoke
// Il2CppName: EndInvoke
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (Valve::VR::CVROverlay::_PollNextOverlayEventPacked::*)(ByRef<Valve::VR::VREvent_t_Packed>, System::IAsyncResult*)>(&Valve::VR::CVROverlay::_PollNextOverlayEventPacked::EndInvoke)> {
  static const MethodInfo* get() {
    static auto* pEvent = &::il2cpp_utils::GetClassFromName("Valve.VR", "VREvent_t_Packed")->this_arg;
