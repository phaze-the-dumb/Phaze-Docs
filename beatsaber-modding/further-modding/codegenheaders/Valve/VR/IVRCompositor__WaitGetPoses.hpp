...
namespace Valve::VR {
  ...
  // [UnmanagedFunctionPointerAttribute] Offset: DF84C4
  class IVRCompositor::_WaitGetPoses : public System::MulticastDelegate {
    ...
    // Offset: 0x205BDE4
    Valve::VR::EVRCompositorError Invoke(ByRef<::Array<Valve::VR::TrackedDevicePose_t>*> pRenderPoseArray, uint unRenderPoseArrayCount, ByRef<::Array<Valve::VR::TrackedDevicePose_t>*> pGamePoseArray, uint unGamePoseArrayCount);
    ...
    // Offset: 0x205C090
    System::IAsyncResult* BeginInvoke(ByRef<::Array<Valve::VR::TrackedDevicePose_t>*> pRenderPoseArray, uint unRenderPoseArrayCount, ByRef<::Array<Valve::VR::TrackedDevicePose_t>*> pGamePoseArray, uint unGamePoseArrayCount, System::AsyncCallback* callback, ::Il2CppObject* object);
...
// Il2CppName: Invoke
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<Valve::VR::EVRCompositorError (Valve::VR::IVRCompositor::_WaitGetPoses::*)(ByRef<::Array<Valve::VR::TrackedDevicePose_t>*>, uint, ByRef<::Array<Valve::VR::TrackedDevicePose_t>*>, uint)>(&Valve::VR::IVRCompositor::_WaitGetPoses::Invoke)> {
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<System::IAsyncResult* (Valve::VR::IVRCompositor::_WaitGetPoses::*)(ByRef<::Array<Valve::VR::TrackedDevicePose_t>*>, uint, ByRef<::Array<Valve::VR::TrackedDevicePose_t>*>, uint, System::AsyncCallback*, ::Il2CppObject*)>(&Valve::VR::IVRCompositor::_WaitGetPoses::BeginInvoke)> {
  static const MethodInfo* get() {
    static auto* pRenderPoseArray = &il2cpp_functions::array_class_get(::il2cpp_utils::GetClassFromName("Valve.VR", "TrackedDevicePose_t"), 1)->this_arg;
    static auto* unRenderPoseArrayCount = &::il2cpp_utils::GetClassFromName("System", "UInt32")->byval_arg;
    static auto* pGamePoseArray = &il2cpp_functions::array_class_get(::il2cpp_utils::GetClassFromName("Valve.VR", "TrackedDevicePose_t"), 1)->this_arg;
