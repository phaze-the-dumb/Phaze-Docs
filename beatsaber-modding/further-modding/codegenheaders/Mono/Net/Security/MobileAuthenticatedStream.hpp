...
namespace Mono::Net::Security {
  ...
  class MobileAuthenticatedStream : public System::Net::Security::AuthenticatedStream/*, public Mono::Security::Interface::IMonoSslStream*/ {
    ...
    System::Net::Security::SslStream*& dyn_$SslStream$k__BackingField();
    // Get instance field reference: private readonly Mono.Security.Interface.MonoTlsSettings <Settings>k__BackingField
    Mono::Security::Interface::MonoTlsSettings*& dyn_$Settings$k__BackingField();
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int (Mono::Net::Security::MobileAuthenticatedStream::*)(::Array<uint8_t>*, int, int, ByRef<bool>)>(&Mono::Net::Security::MobileAuthenticatedStream::InternalRead)> {
  static const MethodInfo* get() {
