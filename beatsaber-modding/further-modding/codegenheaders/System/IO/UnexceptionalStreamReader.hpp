...
namespace System::IO {
  ...
  class UnexceptionalStreamReader : public System::IO::StreamReader {
    ...
    int Read(ByRef<::Array<::Il2CppChar>*> dest_buffer, int index, int count);
...
// Il2CppName: Read
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int (System::IO::UnexceptionalStreamReader::*)(ByRef<::Array<::Il2CppChar>*>, int, int)>(&System::IO::UnexceptionalStreamReader::Read)> {
  static const MethodInfo* get() {
