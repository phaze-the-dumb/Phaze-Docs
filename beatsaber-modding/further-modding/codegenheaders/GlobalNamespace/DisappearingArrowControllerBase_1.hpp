...
namespace GlobalNamespace {
  ...
  class DisappearingArrowControllerBase_1 : public UnityEngine::MonoBehaviour {
    ...
    // [SpaceAttribute] Offset: 0xE3C114
    ...
    // [DoesNotRequireDomainReloadInitAttribute] Offset: 0xE3C17C
    ...
    ::Array<GlobalNamespace::MaterialPropertyBlockController*>*& dyn__transparentObjectMaterialPropertyBlocks() {
