...
namespace GlobalNamespace {
  ...
  // [RequireComponent] Offset: E18A34
  // [RequireComponent] Offset: E18A34
  ...
  class ParametricBoxController : public UnityEngine::MonoBehaviour {
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [RangeAttribute] Offset: 0xE1931C
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [SpaceAttribute] Offset: 0xE19334
    // [RangeAttribute] Offset: 0xE19334
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [RangeAttribute] Offset: 0xE19374
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [SpaceAttribute] Offset: 0xE1938C
