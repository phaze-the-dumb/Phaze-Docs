...
namespace Zenject {
  ...
  class PoolableMemoryPoolProvider_5 : public Zenject::PoolableMemoryPoolProviderBase_1<TContract>/*, public Zenject::IValidatable*/ {
    ...
    // Offset: 0x0
    TMemoryPool pool;
    // Creating value type constructor for type: PoolableMemoryPoolProvider_5
    PoolableMemoryPoolProvider_5(TMemoryPool pool_ = {}) noexcept : pool{pool_} {}
    ...
    TMemoryPool& dyn__pool() {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::PoolableMemoryPoolProvider_5::dyn__pool");
    ...
    static PoolableMemoryPoolProvider_5<TParam1, TParam2, TParam3, TContract, TMemoryPool>* New_ctor(Zenject::DiContainer* container, System::Guid poolId) {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::PoolableMemoryPoolProvider_5::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<PoolableMemoryPoolProvider_5<TParam1, TParam2, TParam3, TContract, TMemoryPool>*, creationType>(container, poolId)));
    }
