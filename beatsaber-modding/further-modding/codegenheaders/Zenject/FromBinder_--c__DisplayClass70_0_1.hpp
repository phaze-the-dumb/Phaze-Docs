...
namespace Zenject {
  ...
  // Autogenerated type: Zenject.FromBinder/Zenject.<>c__DisplayClass70_0`1
  ...
  class FromBinder::$$c__DisplayClass70_0_1 : public ::Il2CppObject {
    ...
    // Get instance field: public System.Func`2<Zenject.InjectContext,System.Collections.Generic.IEnumerable`1<TConcrete>> method
    System::Func_2<Zenject::InjectContext*, System::Collections::Generic::IEnumerable_1<TConcrete>*>*& dyn_method() {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::FromBinder::$$c__DisplayClass70_0_1::dyn_method");
      auto ___internal__instance = this;
      static auto ___internal__field__offset = THROW_UNLESS(il2cpp_utils::FindField(___internal__instance, "method"))->offset;
      return *reinterpret_cast<System::Func_2<Zenject::InjectContext*, System::Collections::Generic::IEnumerable_1<TConcrete>*>**>(reinterpret_cast<char*>(this) + ___internal__field__offset);
    }
  ...
  }; // Zenject.FromBinder/Zenject.<>c__DisplayClass70_0`1
  // Could not write size check! Type: Zenject.FromBinder/Zenject.<>c__DisplayClass70_0`1 is generic, or has no fields that are valid for size checks!
}
