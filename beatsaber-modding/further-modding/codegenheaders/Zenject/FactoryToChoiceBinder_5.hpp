...
namespace Zenject {
  ...
  class FactoryToChoiceBinder_5 : public Zenject::FactoryFromBinder_5<TParam1, TParam2, TParam3, TParam4, TContract> {
    public:
    // Creating value type constructor for type: FactoryToChoiceBinder_5
    FactoryToChoiceBinder_5() noexcept {}
    ...
    Zenject::FactoryFromBinder_5<TParam1, TParam2, TParam3, TParam4, TContract>* ToSelf() {
      ...
      return ::il2cpp_utils::RunMethodThrow<Zenject::FactoryFromBinder_5<TParam1, TParam2, TParam3, TParam4, TContract>*, false>(___instance_arg, ___internal__method);
    }
    ...
    Zenject::FactoryFromBinder_5<TParam1, TParam2, TParam3, TParam4, TConcrete>* To() {
      ...
      auto ___instance_arg = this;
      return ::il2cpp_utils::RunMethodThrow<Zenject::FactoryFromBinder_5<TParam1, TParam2, TParam3, TParam4, TConcrete>*, false>(___instance_arg, ___generic__method);
    }
