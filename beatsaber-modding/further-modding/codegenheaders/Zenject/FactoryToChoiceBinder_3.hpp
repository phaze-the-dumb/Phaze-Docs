...
namespace Zenject {
  ...
  class FactoryToChoiceBinder_3 : public Zenject::FactoryFromBinder_3<TParam1, TParam2, TContract> {
    ...
    Zenject::FactoryFromBinder_3<TParam1, TParam2, TContract>* ToSelf() {
      ...
      return ::il2cpp_utils::RunMethodThrow<Zenject::FactoryFromBinder_3<TParam1, TParam2, TContract>*, false>(___instance_arg, ___internal__method);
    }
    ...
    Zenject::FactoryFromBinder_3<TParam1, TParam2, TConcrete>* To() {
      ...
      auto ___instance_arg = this;
      return ::il2cpp_utils::RunMethodThrow<Zenject::FactoryFromBinder_3<TParam1, TParam2, TConcrete>*, false>(___instance_arg, ___generic__method);
    }
