...
namespace UnityEngine {
  ...
  // [NativeClassAttribute] Offset: DB376C
  // [RequiredByNativeCodeAttribute] Offset: DB376C
  // [NativeHeaderAttribute] Offset: DB376C
  struct Rect/*, public System::ValueType, public System::IEquatable_1<UnityEngine::Rect>*/ {
    public:
    // [NativeNameAttribute] Offset: 0xDB82BC
    ...
    // [NativeNameAttribute] Offset: 0xDB82F4
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [NativeNameAttribute] Offset: 0xDB832C
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [NativeNameAttribute] Offset: 0xDB8364
